...
Example: python pipeline.py --category cs.CL --threshold medium --model all-MiniLM-L6-v2

The output will be a file named `ranked_matches.json` in the arxiv_pipeline_data folder containing the matched papers,
"""
